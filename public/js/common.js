...
function createPostHtml(postData, boldFont = false) {
    ...
    var admin = postedBy.admin ? `<i class="fa-solid fa-kiwi-bird" style="margin-left:5px;color:#1D9BF0;" data-toggle="tooltip" data-placement="top" title="Kiwi Employee"></i>` : "";
    ...
    if (postData.postedBy._id == userLoggedIn._id) {
        ...
        buttons = `<button class="deleteButton" data-id="${postData._id}" aria-label="Delete Post" data-toggle="modal" aria-label="Delete Post" data-target="#deletePostModal"><i class="fa-solid fa-trash"></i></button>`
    }
...
function createUserHtml(userData, showFollowButton) {
    ...
    var verifiedGovernment = userData.verifiedGovernment ? `<i class="fa-solid fa-circle-check" style="padding-left:5px;color:#696969;" data-toggle="tooltip" data-placement="top" title="Government Affiliated Account"></i>` : "";
