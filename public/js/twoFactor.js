...
$("#twoFactorSetupButton").click(() => {
	...
	$.ajax({
		...
		success: (data, status, xhr) => {
			...
			$("#twoFactorSetupModalBody").append("<br class='twoFactorResults'>");
			$("#twoFactorSetupModalBody").append("<input type='text' style='margin-bottom: 20px;padding: 5px 10px;border-radius: 2px;border: 1px solid #dedede;background-color: #f2f2f2;'>");
		},
